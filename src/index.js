...
// alert("hello");
// console.log("test");
const messages = ["It is certain", "I doubt it"];

//  "Don't count on it", "Yes definitely", "Signs point to yes", "Outlook not so good", "Concentrate and ask me again"
...
function changeMessage() {
  ...
  eightEl.textContent = '';
  const fortune = getEightBallMessage();
